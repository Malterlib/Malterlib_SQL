...
#ifdef HAVE_EMBEDDED
#define EMBEDDED_LIBS "-L/usr/local/lib/mariadb/ -lmariadbd -ldl -lm -lpthread -l/dev/null"
#endif
...
static void mariadb_get_install_location()
{
  ...
  if (!p || !p[0])
  {
    strncpy(installation_dir, "../../../../../Binaries/MalterlibSDK/Linux/arm64/Linux.sdk/usr/local", PATH_MAX - 1);
    return;
  }
}
